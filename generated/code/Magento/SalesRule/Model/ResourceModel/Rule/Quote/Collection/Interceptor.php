...
class Interceptor extends \Magento\SalesRule\Model\ResourceModel\Rule\Quote\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function setValidationFilter($websiteId, $customerGroupId, $couponCode = '', $now = null, ?\Magento\Quote\Model\Quote\Address $address = null, array $couponCodes = [])
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setValidationFilter');
        return $pluginInfo ? $this->___callPlugins('setValidationFilter', func_get_args(), $pluginInfo) : parent::setValidationFilter($websiteId, $customerGroupId, $couponCode, $now, $address, $couponCodes);
    }
    ...
    public function addWebsiteGroupDateFilter($websiteId, $customerGroupId, $now = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addWebsiteGroupDateFilter', func_get_args(), $pluginInfo) : parent::addWebsiteGroupDateFilter($websiteId, $customerGroupId, $now);
    }
    ...
    public function addAttributeInConditionFilter($attributeCode)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addAttributeInConditionFilter', func_get_args(), $pluginInfo) : parent::addAttributeInConditionFilter($attributeCode);
    }
    ...
    public function addAllowedSalesRulesFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addAllowedSalesRulesFilter', func_get_args(), $pluginInfo) : parent::addAllowedSalesRulesFilter();
    }
    ...
    public function addCustomerGroupFilter($customerGroupId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addCustomerGroupFilter', func_get_args(), $pluginInfo) : parent::addCustomerGroupFilter($customerGroupId);
    }
