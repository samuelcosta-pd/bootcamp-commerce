...
class Interceptor extends \Magento\Theme\Block\Adminhtml\System\Design\Theme\Edit\Tab\Css implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getTabLabel()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getTabLabel', func_get_args(), $pluginInfo) : parent::getTabLabel();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDownloadUrl');
        return $pluginInfo ? $this->___callPlugins('getDownloadUrl', func_get_args(), $pluginInfo) : parent::getDownloadUrl($fileId, $themeId);
    }
    ...
    public function getTabTitle()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getTabTitle', func_get_args(), $pluginInfo) : parent::getTabTitle();
    }
