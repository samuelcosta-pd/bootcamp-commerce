...
class Interceptor extends \Magento\Theme\Block\Adminhtml\System\Design\Theme\Edit\Tab\Js implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getJsUploadUrl');
        return $pluginInfo ? $this->___callPlugins('getJsUploadUrl', func_get_args(), $pluginInfo) : parent::getJsUploadUrl();
    }
