<?php
namespace Magento\GoogleAdwords\Model\Config\Backend\Color;

/**
 * Interceptor class for @see \Magento\GoogleAdwords\Model\Config\Backend\Color
 */
class Interceptor extends \Magento\GoogleAdwords\Model\Config\Backend\Color implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConversionColor');
        return $pluginInfo ? $this->___callPlugins('getConversionColor', func_get_args(), $pluginInfo) : parent::getConversionColor();
    }
