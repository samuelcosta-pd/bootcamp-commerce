<?php
namespace Magento\GoogleAdwords\Model\Config\Backend\ConversionId;

/**
 * Interceptor class for @see \Magento\GoogleAdwords\Model\Config\Backend\ConversionId
 */
class Interceptor extends \Magento\GoogleAdwords\Model\Config\Backend\ConversionId implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $validatorCompositeFactory, $validatorFactory, $resource, $resourceCollection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConversionId');
        return $pluginInfo ? $this->___callPlugins('getConversionId', func_get_args(), $pluginInfo) : parent::getConversionId();
    }
