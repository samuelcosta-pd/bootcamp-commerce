<?php
namespace Magento\Indexer\Console\Command\IndexerSetModeCommand;

/**
 * Interceptor class for @see \Magento\Indexer\Console\Command\IndexerSetModeCommand
 */
class Interceptor extends \Magento\Indexer\Console\Command\IndexerSetModeCommand implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function validate(\Symfony\Component\Console\Input\InputInterface $input)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'validate');
        return $pluginInfo ? $this->___callPlugins('validate', func_get_args(), $pluginInfo) : parent::validate($input);
    }
    ...
    public function ignoreValidationErrors(): void
    {
        ...
        $pluginInfo ? $this->___callPlugins('ignoreValidationErrors', func_get_args(), $pluginInfo) : parent::ignoreValidationErrors();
    }
    ...
    public function setApplication(?\Symfony\Component\Console\Application $application): void
    {
        ...
        $pluginInfo ? $this->___callPlugins('setApplication', func_get_args(), $pluginInfo) : parent::setApplication($application);
    }
    ...
    public function setHelperSet(\Symfony\Component\Console\Helper\HelperSet $helperSet): void
    {
        ...
        $pluginInfo ? $this->___callPlugins('setHelperSet', func_get_args(), $pluginInfo) : parent::setHelperSet($helperSet);
    }
    ...
    public function addArgument(string $name, ?int $mode = null, string $description = '', mixed $default = null, \Closure|array $suggestedValues = []): static
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addArgument', func_get_args(), $pluginInfo) : parent::addArgument($name, $mode, $description, $default, $suggestedValues);
    }

    /**
     * {@inheritdoc}
     */
    public function addOption(string $name, string|array|null $shortcut = null, ?int $mode = null, string $description = '', mixed $default = null, \Closure|array $suggestedValues = []): static
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOption');
        return $pluginInfo ? $this->___callPlugins('addOption', func_get_args(), $pluginInfo) : parent::addOption($name, $shortcut, $mode, $description, $default, $suggestedValues);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubscribedSignals');
        return $pluginInfo ? $this->___callPlugins('getSubscribedSignals', func_get_args(), $pluginInfo) : parent::getSubscribedSignals();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'handleSignal');
        return $pluginInfo ? $this->___callPlugins('handleSignal', func_get_args(), $pluginInfo) : parent::handleSignal($signal, $previousExitCode);
    }
}
