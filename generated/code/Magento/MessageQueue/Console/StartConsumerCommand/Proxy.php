...
class Proxy extends \Magento\MessageQueue\Console\StartConsumerCommand implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    ...
    {
        $this->_getSubject()->ignoreValidationErrors();
    }
    ...
    {
        $this->_getSubject()->setApplication($application);
    }
    ...
    {
        $this->_getSubject()->setHelperSet($helperSet);
    }
    ...
    {
        return $this->_getSubject()->addArgument($name, $mode, $description, $default, $suggestedValues);
    }
    ...
    {
        return $this->_getSubject()->addOption($name, $shortcut, $mode, $description, $default, $suggestedValues);
    }
    ...
    {
        return $this->_getSubject()->getSubscribedSignals();
    }
    ...
    {
        return $this->_getSubject()->handleSignal($signal, $previousExitCode);
    }
}
