...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Report\Filter\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFieldVisibility');
        return $pluginInfo ? $this->___callPlugins('setFieldVisibility', func_get_args(), $pluginInfo) : parent::setFieldVisibility($fieldId, $visibility);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFieldVisibility');
        return $pluginInfo ? $this->___callPlugins('getFieldVisibility', func_get_args(), $pluginInfo) : parent::getFieldVisibility($fieldId, $defaultVisibility);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFieldOption');
        return $pluginInfo ? $this->___callPlugins('setFieldOption', func_get_args(), $pluginInfo) : parent::setFieldOption($fieldId, $option, $value);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addReportTypeOption');
        return $pluginInfo ? $this->___callPlugins('addReportTypeOption', func_get_args(), $pluginInfo) : parent::addReportTypeOption($key, $value);
    }
